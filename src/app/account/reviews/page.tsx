  ...
  return (
    <div className="max-w-[768px] mx-auto px-4 py-6 animate-fade-in">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-h1" style={{ color: 'var(--primary-text)' }}>My Reviews</h1>
          <p className="text-sm text-secondary-text">{userData?.reviewsCount || 0} reviews shared</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h3 className="text-lg font-medium mb-2" style={{ color: 'var(--primary-text)' }}>No reviews yet</h3>
        <p className="text-sm text-secondary-text max-w-xs mb-8">Your reviews help the community find the best hidden gems.</p>
      </div>
    </div>
  );
}
