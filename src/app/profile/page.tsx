...
import { Calendar, User, Settings, Star, MapPin, Heart, Shield, LogOut } from 'lucide-react';
  ...
  return (
    <div className="max-w-[768px] mx-auto px-4 py-6 animate-fade-in">
      ...
      <div className="flex items-center gap-4 mb-8">
        <div className="w-20 h-20 rounded-full bg-brand-ember flex items-center justify-center text-white text-2xl font-bold flex-shrink-0">
          {userData.photoURL ? (
