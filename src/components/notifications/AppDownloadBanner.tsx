...
export default function AppDownloadBanner() {
  ...
  return (
    <div className="fixed bottom-24 lg:bottom-8 left-4 right-4 lg:left-auto lg:right-8 lg:w-[400px] z-40 animate-slide-up">
      <div className="glass rounded-[32px] p-6 border border-border shadow-2xl relative overflow-hidden group">
        {/* Glow effect */}
        ...
        <button 
          ...
          className="absolute top-4 right-4 p-1 hover:bg-elevated/20 rounded-full transition-colors text-secondary-text"
        >
          <X size={16} />
        </button>
